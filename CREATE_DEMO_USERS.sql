...
-- 1. Tạo phòng ban Admin và Kinh Doanh
...
-- 2. Tạo/Cập nhật tài khoản admin với mật khẩu Admin@123
...
-- 3. Tạo tài khoản demo manager_kd / Manager@123
INSERT INTO hast_crm.users (id, username, password_hash, salt, full_name, role, department_id, status)
VALUES (
    'usr_manager_kd',
    'manager_kd',
...
-- 4. Tạo tài khoản demo staff_kd_01 / Staff@123
INSERT INTO hast_crm.users (id, username, password_hash, salt, full_name, role, department_id, status)
VALUES (
    'usr_staff_kd_01',
    'staff_kd_01',
